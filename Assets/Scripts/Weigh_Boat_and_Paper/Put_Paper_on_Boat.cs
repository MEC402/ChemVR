...
public class Put_Paper_on_Boat : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        {
            UnityEngine.Debug.LogError("XRGrabInteractable component is missing.");
            return;
        }
        ...
        {
            UnityEngine.Debug.LogError("flat paper components are missing.");
            return;
        }
        if (foldedPaperCollider == null || foldedPaperRenderer == null)
        {
            UnityEngine.Debug.LogError("folded paper components are missing.");
            return;
        }
        if (halfFoldedPaperCollider == null || halfFoldedPaperRenderer == null)
        {
            UnityEngine.Debug.LogError("half folded paper components are missing.");
            return;
        }
