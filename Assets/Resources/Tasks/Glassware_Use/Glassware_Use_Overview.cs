...
public class Glassware_Use_Overview : MonoBehaviour
{
    ...
    string[] text = {"Welcome to Glassware Identification!\nBefore we begin the lab, you need to put on your lab gear.\n\nYou should be wearing closed toed shoes and have your hair tied back.\n\nFind gloves, goggles, and a lab coat and put them on with (X/A). \n\nPRESS B TO SKIP INSTRUCTIONS! ",
                    ...
                    //"Finally you will need:\nSmall Weigh Boat With Paper\nCopper Sulfate\nPaper Towels\n\n\nSkip with B", //disabled task step 4 (add to TaskInfoSO block and uncomment to undo)
                    //"Locate these tools that you will need in the lab:\nAnalytical Balance\nBalance Brush\nDI water\nWhen you are ready to continue, press (A).\n\n\nSkip with B", //disabled task step 5 (add to TaskInfoSO block and uncomment to undo)
                    ...
                    "Bring a graduated cylinder (Beaker) over to the DI water.\n\nFill it until the meniscus is at 50mL.\n\n\nSkip with B",
