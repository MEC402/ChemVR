...
public class Glassware_Use_Overview : MonoBehaviour
{
    ...
    string[] text = {/*0*/"Welcome!\nBefore we begin the lab, you need to put on your lab gear.\n\nYou should be wearing closed toed shoes and have your hair tied back.\n\nFind gloves, goggles, and a lab coat and put them on with (B).",
                    ...
                    /*13*/"Pour 50mL of DI water from graduated Cylinder into 250mL beaker.\n\n\nSkip with A",
                    /*14*/"Mix copper sulfate and water with the glass stir rod.\n\n\nSkip with A",
                    //"Mix copper sulfate and water with the glass stir rod and write down any chemical changes in your notebook.\n\n\nSkip with A",
                    /*15*/"Line up 3 volumetric flasks.\n\nFill each flask with 15mL of the blue fluid using the volumetric pipette.\n\n\nSkip with A",
                    /*16*/"Fill flasks with 25mL, 35mL, 45mL water respectively and observe and record changes.\n\n\nSkip with A",
                    /*17*/"Time to clean up! Pre-rinse your glasses with tap water.\n\n\nSkip with A",
                    /*18*/"Wash your glassware with soapy water to remove any residues.\n\n\nSkip with A",
                    /*19*/"Scrub the inside of the glassware with a brush.\n\n\nSkip with A",
                    /*20*/"Rinse the glassware with the DI bottle.\n\n\nSkip with A",
