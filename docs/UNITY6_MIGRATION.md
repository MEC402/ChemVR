...
- **`com.unity.xr.mock-hmd` 1.4.0-preview.2.** A preview package whose loader,
  like ARCore's, is not assigned to any build target. Probably dead weight, but
  left alone to keep this migration's blast radius small.
